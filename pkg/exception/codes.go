...
var (
	...
	E1004 = ErrorCode{code: "E1004", message: "Request timed out. Please try again."}
	E1005 = ErrorCode{code: "E1005", message: "Invalid argument. Please ensure the argument is correct."}
	E1006 = ErrorCode{code: "E1006", message: "The request was directed to a server that is unable to respond. Please ensure the request parameters are correct."}
	E1007 = ErrorCode{code: "E1007", message: "Too many requests have been made recently. Please try again later."}
	E1008 = ErrorCode{code: "E1008", message: "A dependency has failed. Please try again."}
